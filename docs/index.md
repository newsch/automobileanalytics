...
Evan New-Schmidt and Max Otoadese
...
for other vehicles on the road, while unskilled drivers can unknowingly create uncomfortable (and potentially unsafe) situations for themselves and others.

New drivers often don't know what a smooth shift, a smooth turn, or a safe stop feels like.

Ridesharing drivers may receive unactionable feedback about their driving abilities through reviews and ratings.

**Automobile Analytics intends to make it easier for anyone to gain feedback on their driving through analysis of smartphone data.**

## How it works
By utilizing the accelerometer and gyroscope found in smartphones, we can identify different driving maneuvers such as turning, braking, starting, and shifting (for manual cars). After identifying maneuvers,
the forces can be quantified and compared against recommended values.

<img src="img/Car_reference_frames.svg" alt="Car-Phone Reference Frames" height="800" width="400" style="text-align:center;">
...
_Turns are detected by temporary rises in lateral (X axis) acceleration._

<img src="img/straight_corrected_acc.svg" alt="visual of 4-stroke engine cycle" width="400" style="text-align:center;">

_Braking, acceleration, and shifting can all be recognized by analyzing the acceleration along the y axis of the vehicle. The max acceleration felt by passengers is below the recommended maximum of 0.3Gs._
...
<img src="img/4stroke_cycle.gif" alt="visual of 4-stroke engine cycle" width="300" style="text-align:center;">

_In most four-cylinder engines, there are two combustions per revolution of the crankshaft ([image source](https://xorl.wordpress.com/2011/03/05/the-basics-of-4-stroke-internal-combustion-engines/))._
...
<img src="img/rpm_conversion_eqn.svg" alt="rpm conversion equation" style="text-align:center;">
...
<img src="img/engine_frequency750.svg" alt="measured frequencies at 750RPM" width="400" style="text-align:center;">
...
<img src="img/engine_frequency2000.svg" alt="measured frequencies at 2000RPM" width="400" style="text-align:center;">
<img src="img/engine_frequency3000.svg" alt="measured frequencies at 3000RPM" width="400" style="text-align:center;">
...
There are several possible steps forward.

In order to better determine engine RPM, most modern phones support at least sampling rates of at least 200Hz, which would double our measurable range.
